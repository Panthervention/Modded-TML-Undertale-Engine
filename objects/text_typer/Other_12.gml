...
switch(cmd[|0]){
	...
	case "if":
		...
		target_0=(is_real(target_0) ? real(target_0) : target_0);
		target_1=(is_real(target_1) ? real(target_1) : target_1);
	...
	case "skip_space":
		...
		break;
	case "sans_head":
        battle_enemy_sans._head_image = cmd[|1];
        break;
	case "sans_sweat":
        battle_enemy_sans.sweat_image = cmd[|1];
        break;
	case "sans_body":
        battle_enemy_sans._body_image = cmd[|1];
        break;
	case "choicephase":
