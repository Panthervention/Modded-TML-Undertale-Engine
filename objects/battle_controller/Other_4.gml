...
instance_create_depth(87,453,0,battle_button_fight);
instance_create_depth(240,453,0,battle_button_act);
instance_create_depth(400,453,0,battle_button_item);
instance_create_depth(555,453,0,battle_button_mercy);
